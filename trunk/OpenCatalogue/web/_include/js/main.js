...
BRUSHED.queryUrl = function(url){ 
var template_example = "<p><a href=\"<%=value%>\" target=\"_blank\" data-toggle=\"tooltip\" title=\"<%=title%>\"><%=value%></a></p>"    

$.getJSON( url, function( data ) {
  $.each( data.rows, function( index, obj ) {
      var link = _.template(template_example,obj);
      $("#link_examples").append(link);
  });
});
}
