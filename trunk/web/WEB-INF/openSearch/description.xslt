...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:xdt="http://www.w3.org/2005/02/xpath-datatypes" xmlns:rep="http://ngeo.eo.esa.int/schema/browseReport" xmlns:gml="http://www.opengis.net/gml" xmlns:gsc="http://earth.esa.int/gsc" xmlns:bsi="http://ngeo.eo.esa.int/schema/browse/ingestion" xmlns:om="http://www.opengis.net/om/2.0" xmlns:gml32="http://www.opengis.net/gml/3.2" xmlns:eop="http://earth.esa.int/eop" xmlns:opt="http://earth.esa.int/opt" xmlns:atm="http://earth.esa.int/atm" xmlns:sar="http://earth.esa.int/sar" xmlns:eop2="http://www.opengis.net/eop/2.0" xmlns:opt2="http://www.opengis.net/opt/2.0" xmlns:atm2="http://www.opengis.net/atm/2.0" xmlns:sar2="http://www.opengis.net/sar/2.0">
    ...
    <!--Image height="55" width="150" type="image/png">http://gpod.eo.esa.int/template/images/logo_gpod_transparent.png</Image-->
    <!--Image height="16" width="16" type="image/vnd.microsoft.icon">http://gpod.eo.esa.int/favicon.ico</Image-->
                    ...
                    <Url type="text/plain" indexOffset="0" pageOffset="0" template="" >
                                    <xsl:attribute name="template">
                            <xsl:value-of select="$url"/>/wkt/?q={searchTerm}&amp;count={count}&amp;startIndex={startIndex?}&amp;startPage={startPage?}&amp;language={language?}&amp;inputEncoding={inputEncoding?}&amp;outputEncoding={outputEncoding?}&amp;bbox={geo:box?}&amp;geom={geo:geometry?}&amp;id={geo:uid?}&amp;lat={geo:lat?}&amp;lon={geo:lon?}&amp;radius={geo:radius?}&amp;rel={geo:relation?}&amp;loc={geo:name&amp;}&amp;startdate={time:start?}&amp;stopdate={time:end?}&amp;&amp;tp={cseop:timePosition?}&amp;psn={cseop:platformShortName?}&amp;psi={cseop:platformSerialIdentifier?}&amp;ot={cseop:orbitType?}&amp;isn={cseop:instrumentShortName?}&amp;st={cseop:sensorType?}&amp;som={cseop:sensorOperationalMode?}&amp;si={cseop:swathIdentifier?}
                        </xsl:attribute>
                    </Url>
                    <Url type="application/xhtml+xml" indexOffset="0" pageOffset="0" template="">
                        <xsl:attribute name="template">
                            <xsl:value-of select="$url"/>/solr/?q={searchTerm}&amp;count={count}&amp;startIndex={startIndex?}&amp;startPage={startPage?}&amp;language={language?}&amp;inputEncoding={inputEncoding?}&amp;outputEncoding={outputEncoding?}&amp;bbox={geo:box?}&amp;geom={geo:geometry?}&amp;id={geo:uid?}&amp;lat={geo:lat?}&amp;lon={geo:lon?}&amp;radius={geo:radius?}&amp;rel={geo:relation?}&amp;loc={geo:name&amp;}&amp;startdate={time:start?}&amp;stopdate={time:end?}&amp;&amp;tp={cseop:timePosition?}&amp;psn={cseop:platformShortName?}&amp;psi={cseop:platformSerialIdentifier?}&amp;ot={cseop:orbitType?}&amp;isn={cseop:instrumentShortName?}&amp;st={cseop:sensorType?}&amp;som={cseop:sensorOperationalMode?}&amp;si={cseop:swathIdentifier?}
                        </xsl:attribute>
                    </Url>
                    <Url type="application/atom+xml" indexOffset="0" pageOffset="0" template="" >
                        <xsl:attribute name="template">
                            <xsl:value-of select="$url"/>/atom/?q={searchTerm}&amp;count={count}&amp;startIndex={startIndex?}&amp;startPage={startPage?}&amp;language={language?}&amp;inputEncoding={inputEncoding?}&amp;outputEncoding={outputEncoding?}&amp;bbox={geo:box?}&amp;geom={geo:geometry?}&amp;id={geo:uid?}&amp;lat={geo:lat?}&amp;lon={geo:lon?}&amp;radius={geo:radius?}&amp;rel={geo:relation?}&amp;loc={geo:name&amp;}&amp;startdate={time:start?}&amp;stopdate={time:end?}&amp;&amp;tp={cseop:timePosition?}&amp;psn={cseop:platformShortName?}&amp;psi={cseop:platformSerialIdentifier?}&amp;ot={cseop:orbitType?}&amp;isn={cseop:instrumentShortName?}&amp;st={cseop:sensorType?}&amp;som={cseop:sensorOperationalMode?}&amp;si={cseop:swathIdentifier?}
                        </xsl:attribute>            
                    </Url>
