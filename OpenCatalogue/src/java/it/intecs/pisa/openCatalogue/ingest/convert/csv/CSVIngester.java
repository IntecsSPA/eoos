 ...
 */
package it.intecs.pisa.openCatalogue.ingest.convert.csv;
...
public class CSVIngester {
    ...
    public static void main(String[] args) throws Exception {
        ...
        CSVIngester harv = new CSVIngester(repository, configuration, url, isTomcatCall);
     ...
     * @throws Exception
     */
    public CSVIngester(AbstractFilesystem metadataRepository, AbstractFilesystem configDirectory, String solrURL, boolean isTomcatCall) throws SAXException, IOException, SaxonApiException, Exception {
